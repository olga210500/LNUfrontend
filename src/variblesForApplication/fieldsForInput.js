const fieldsForInput = [
  ...
  {
    title:
      "Вкажіть відділ та посаду за сумісництвом (за наявності,якщо немає ставте '-')",
    type: "text",
  ...
  },
  {
    ...
    name: "country",
    id: "country",
    placeholder: "Якщо відрядження по Україні, впишіть 'U'",
    required: "required",
  },
  {
  ...
  },
  {
    ...
    name: "route",
    id: "route",
    placeholder: "Для закордонного відрядження поставте '-'",
    required: "required",
  },
  {
    title: "Вкажіть установу, куди відряджаєтесь",
    type: "text",
    name: "institution",
    id: "institution",
  ...
  {
    title:
      "Вкажіть транспорт, яким будете подорожувати (для відряджень по Україні)",
    type: "text",
    name: "transport",
    id: "transport",
  ...
  },
  {
    ...
    id: "expensesPayment",
    placeholder:
      "Наприклад: Витрати добові за власний кошт/ за рахунок приймаючої сторони",
    required: "required",
  },
  {
